...
#'   \item \code{width}: (Optional) A numeric value that specifies the width of the column. If not provided,
#'   the width is determined based on the content of the column.
