...
#'   \item \code{pct}: (Optional) A numeric value that specifies the percentage width of the column, relative to
#'   its parent. If not provided, the percentage is determined based on the content of the column.
